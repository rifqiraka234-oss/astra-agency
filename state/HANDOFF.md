...
> failure. For this file that means a handoff is a claim about state, so re verify every file
> path, byte size and hash against the repo as it stands now rather than trusting what
> this note says.
