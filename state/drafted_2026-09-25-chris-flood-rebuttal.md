...
below is transcribed from Raka's screenshot rather than from the API.
...
"is going to go through many changes over the coming months".

So the rebuttal is a real question rather than a save. It gives him an easy exit, which is
the only version of this that gets an answer.

REPLY.

```
Fair enough Chris, and thanks for opening it and coming back to me rather than leaving it.

Real question though. I built from your two sites as they stand today, because that's all I had to go on. You'd said the direction is changing but not what it's changing to, so I was aiming at a target I couldn't see.

So where are you taking it? If it's not our kind of work I'll say so myself and leave you be. If it is, I'd rather show you the version that fits the plan than the one that fits the old site.
```
