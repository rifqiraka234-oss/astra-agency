...
> failure. For this file that means craft density and art direction are judged from screenshots
> actually opened, against reference pages actually loaded, never from a memory of
